% Code from: Jeffrey Chiou (2021). Flexible and Fast Spike Raster Plotting (https://www.mathworks.com/matlabcentral/fileexchange/45671-flexible-and-fast-spike-raster-plotting), MATLAB Central File Exchange. Retrieved May 18, 2021.

function [xPoints, yPoints] = raster(spikes,varargin)
...
LineFormat.Color = [84/256 214/256 201/256];
